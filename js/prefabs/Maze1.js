...
Platformer.MazeLevel1 = function () {};


Platformer.MazeLevel1.prototype = {
    ...
    create: function() {
        ...
        // SOUND
        this.music_ambiance = this.add.audio('ambiance1');
        ...
        // CREATE BAMBOO
            ...
            var c = this.bambooGroup.create(700, 140, 'bamboo');

            c = this.bambooGroup.create(1480, 190, 'bamboo');

            c = this.bambooGroup.create(650, 770, 'bamboo');

        // CREATE PLAYER SPRITE  → 
            this.sprite = this.add.sprite(540, 840, 'player_maze_move');//postiton SPAWN PLAYER
        ...
        // CREATE CLOUD
            ...
            game.add.tween(this.bambooGroup).to( { y: +5}, 2000, "Linear", true, 0, -1, true);

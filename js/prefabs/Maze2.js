...
Platformer.MazeLevel2 = function () {};


Platformer.MazeLevel2.prototype = {

    // création map
    create: function() {

        //TUTO
        // this.edito = this.add.image(1100, 180, 'edito_1');
        // this.edito.scale.setTo(.85);
        // this.game.time.events.loop(10000, this.edito_destroy, this);

        // SOUND
        this.music_ambiance = this.add.audio('ambiance2');
        ...
        console.log(this.game._width, this.game._height);
            // bg color canvas → 
        ...
        // CREATE BAMBOO
            ...
            this.camera.follow(this.sprite, 0.1,0.1);

            this.bambooGroup = this.add.physicsGroup();

            var c = this.bambooGroup.create(327, 135, 'bamboo');

            c = this.bambooGroup.create(1270, 860, 'bamboo');

            c = this.bambooGroup.create(1060, 240, 'bamboo');

            c = this.bambooGroup.create(327, 815, 'bamboo');

            c = this.bambooGroup.create(695, 556, 'bamboo');

            console.log(this.bambooGroup);



        // CREATE PLAYER SPRITE  → 
            this.sprite = this.add.sprite(800, 825, 'player_maze_move');//postiton SPAWN PLAYER
...
var Enemies = function(game, x1, y1, x2, y2) {
    ...
    // --------  DEPLACEMENT ENNEMIE 1
        ...
        game.enemies1.SPEED = 70; // missile speed pixels/second
    ...
    // --------  DEPLACEMENT ENNEMIE 2
        ...
        // Define constants that affect motion
        game.enemies2.SPEED = 70; // missile speed pixels/second

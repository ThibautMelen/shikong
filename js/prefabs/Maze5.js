...
Platformer.MazeLevel5 = function () {};


Platformer.MazeLevel5.prototype = {
    ...
    create: function() {
        ...
        // CREATE BAMBOO
            ...
            var c = this.bambooGroup.create(330, 240, 'bamboo');

            c = this.bambooGroup.create(275, 240, 'bamboo');

            c = this.bambooGroup.create(1524, 240, 'bamboo');

            c = this.bambooGroup.create(1212, 875, 'bamboo');

            c = this.bambooGroup.create(800, 875, 'bamboo');

            c = this.bambooGroup.create(485, 137, 'bamboo');

            c = this.bambooGroup.create(485, 875, 'bamboo');

            c = this.bambooGroup.create(1270, 137, 'bamboo');

            c = this.bambooGroup.create(900, 450, 'bamboo');

            c = this.bambooGroup.create(647, 295, 'bamboo');

            c = this.bambooGroup.create(697, 607, 'bamboo');

            c = this.bambooGroup.create(330, 607, 'bamboo');          

            c = this.bambooGroup.create(1420, 710, 'bamboo');

            c = this.bambooGroup.create(855, 187, 'bamboo');

            c = this.bambooGroup.create(275, 762, 'bamboo');

            c = this.bambooGroup.create(590, 762, 'bamboo');

            c = this.bambooGroup.create(1110, 762, 'bamboo');

            c = this.bambooGroup.create(1110, 400, 'bamboo');




        // CREATE PLAYER SPRITE  → 
            this.sprite = this.add.sprite(1350, 500, 'player_maze_move');//postiton SPAWN PLAYER
...
var Enemies = function(game, x1, y1, x2, y2) {
    ...
    // --------  DEPLACEMENT ENNEMIE 1
        ...
        game.enemies1.SPEED = 30; // missile speed pixels/second
    ...
    // --------  DEPLACEMENT ENNEMIE 2
        ...
        // Define constants that affect motion
        game.enemies2.SPEED = 20; // missile speed pixels/second

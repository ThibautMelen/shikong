...
Platformer.MazeLevel4 = function () {};


Platformer.MazeLevel4.prototype = {
    ...
    create: function() {
        ...
        // CREATE BAMBOO
            ...
            c = this.bambooGroup.create(1105, 862, 'bamboo');

            c = this.bambooGroup.create(960, 85, 'bamboo');

            c = this.bambooGroup.create(750, 450, 'bamboo');

            c = this.bambooGroup.create(805, 295, 'bamboo');

             c = this.bambooGroup.create(1060, 295, 'bamboo');

             c = this.bambooGroup.create(327, 814, 'bamboo');

             c = this.bambooGroup.create(900, 814, 'bamboo');

            c = this.bambooGroup.create(1320, 605, 'bamboo');

            c = this.bambooGroup.create(432, 710, 'bamboo');

            c = this.bambooGroup.create(1472, 187, 'bamboo');
